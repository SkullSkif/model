...
// Функция для сохранения частоты переходов
...
int main() {
    ...
    cout << "\nМатрицы сохранены в файлы matrix1.txt и matrix2.txt" << endl;
    ...
    // Сохраняем частоты переходов
    saveTransitionFrequency(transition_count1, "frequencies1.txt");
    saveTransitionFrequency(transition_count2, "frequencies2.txt");
    cout << "\nЧастоты переходов сохранены в файлы frequencies1.txt и frequencies2.txt" << endl;
    
    // Сохраняем данные для графиков траекторий
    saveTransitionData(states1, "states1.dat");
    saveTransitionData(states2, "states2.dat");
    cout << "Данные траекторий сохранены в states1.dat и states2.dat" << endl;
    ...
    cout << "Данные автокорреляции сохранены в autocorr1.dat и autocorr2.dat" << endl;
